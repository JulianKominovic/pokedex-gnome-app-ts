...
export class Application extends Adw.Application {
    ...
    constructor() {
        super({
            application_id: 'com.jkominovic.pokedex',
        ...
        show_about_action.connect('activate', () => {
            const aboutWindow = new Adw.AboutWindow({
                ...
                application_name: _('pokedex'),
                application_icon: 'com.jkominovic.pokedex',
                developer_name: 'jkominovic',
                version: '0.1',
                developers: ['jkominovic <juliankominovic@gmail.com>'],
                copyright: '© 2023 jkominovic',
            });
